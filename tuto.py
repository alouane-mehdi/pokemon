...
class Regles:
    ...
    def run(self):
        while self.running:
            ...
            self.afficher_texte_position_y("Bienvenue dans Pokémon !", self.position_y)
            ...
            self.afficher_texte_position_y("Appuyez sur 'P' pour afficher le pokédex", self.position_y + 250)
...
# Créer une instance de la classe et exécuter 
