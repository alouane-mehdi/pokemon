...
class Jeu:
    ...
    def initialiserPersonnages(self):
        personnages_disponibles = [
            Personnage("Pikachu", 13, "image/pikachu.png", scale_factor=5),
            Personnage("Carapuce", 23, "image/carapuce.png", scale_factor=5),
            Personnage("Salamèche", 33, "image/salameche.png", scale_factor=5),
            Personnage("Bulbizarre", 43, "image/bulbizarre.png", scale_factor=5)
        ]
    ...
    def lancerJeu(self):
        ...
        arena_image = pygame.image.load("image/arene.webp")
